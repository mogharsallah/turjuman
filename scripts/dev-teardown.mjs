...
// per-stack counterpart to `npm run localstack:down`, which stops the whole emulator.
...
//
// Prereq: LocalStack running (npm run localstack:up).
//
...
// delete it explicitly to fully clean up so the next `npm run dev` re-creates it.
