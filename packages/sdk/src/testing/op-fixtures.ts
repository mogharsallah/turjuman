...
export const ACTOR: Actor = { userId: "actor-sentinel", orgId: "org-sentinel", globalRole: "OWNER" };
...
export const OP_FIXTURES: Record<string, OpFixture | OpFixture[]> = {
  // ---- projects --------------------------------------------------------------
  list_projects: { input: {}, calls: [{ method: "projects.list", args: [ACTOR] }] },
  get_project: {
    ...
    calls: [
      {
        ...
        args: [ACTOR, { name: "N_name", baseLocale: "zz", description: "D_description" }],
      },
    ],
  },
  update_project: {
    input: { projectId: "P_projectId", name: "N_name", description: "D_description", baseLocale: "zz" },
    calls: [
      {
        method: "projects.update",
        args: [ACTOR, "P_projectId", { name: "N_name", description: "D_description", baseLocale: "zz" }],
      },
    ],
  },
  list_locales: {
  ...
  add_locale: {
    ...
    calls: [{ method: "locales.add", args: [ACTOR, "P_projectId", "zz", "N_name"] }],
  },
  ...
  list_keys: [
    {
      ...
      input: { projectId: "P_projectId", namespace: "NS_ns", tag: "T_tag", limit: 7, cursor: "CUR_cursor" },
      calls: [
        {
          method: "keys.listPage",
          args: [ACTOR, "P_projectId", { namespace: "NS_ns", tag: "T_tag", limit: 7, cursor: "CUR_cursor" }],
        },
      ],
    },
    {
      ...
      calls: [
        { method: "keys.list", args: [ACTOR, "P_projectId", { namespace: "NS_ns", tag: "T_tag" }] },
      ],
    },
  ],
  search_keys: [
    {
      ...
      input: { projectId: "P_projectId", query: "Q_query", limit: 7, cursor: "CUR_cursor" },
      calls: [
        {
          method: "keys.searchPage",
          args: [ACTOR, "P_projectId", "Q_query", { limit: 7, cursor: "CUR_cursor" }],
        },
      ],
    },
    {
      variant: "default limit (?? 100)",
      input: { projectId: "P_projectId", query: "Q_query", cursor: "CUR_cursor" },
      calls: [
        {
          method: "keys.searchPage",
          args: [ACTOR, "P_projectId", "Q_query", { limit: 100, cursor: "CUR_cursor" }],
        },
      ],
    },
  ],
  get_key: {
    ...
    calls: [{ method: "keys.get", args: [ACTOR, "P_projectId", "N_name", "NS_ns"] }],
  },
  create_key: {
    input: {
    ...
    calls: [
      {
        ...
        args: [
          ...
          "P_projectId",
          "N_name",
          { description: "D_description", plural: true, maxLength: 99, tags: ["TG_tag1"] },
          "NS_ns",
        ],
      },
    ],
  ...
  delete_key: {
    input: { projectId: "P_projectId", name: "N_name", namespace: "NS_ns", confirm: true },
    calls: [{ method: "keys.delete", args: [ACTOR, "P_projectId", "N_name", true, "NS_ns"] }],
  ...
  get_translations: [
    {
      ...
      input: { projectId: "P_projectId", name: "N_name", namespace: "NS_ns" },
      calls: [
        { method: "translations.listForKey", args: [ACTOR, "P_projectId", "N_name", "NS_ns"] },
      ],
    },
    {
      variant: "by locale (paged)",
      input: { projectId: "P_projectId", locale: "zz", limit: 7, cursor: "CUR_cursor" },
      calls: [
        {
    ...
    calls: [
      {
        ...
        args: [
          ...
          "P_projectId",
          "zz",
          { name: "N_name", namespace: "NS_ns", value: "V_value", status: "approved", origin: "llm" },
        ],
      },
    ],
  },
  bulk_set_translations: {
    input: {
      projectId: "P_projectId",
      locale: "zz",
      entries: [{ name: "N_name", namespace: "NS_ns", value: "V_value", status: "approved" }],
    },
    calls: [
      {
  ...
  set_translation_status: {
    input: { projectId: "P_projectId", locale: "zz", name: "N_name", namespace: "NS_ns", status: "approved" },
    calls: [
      {
  ...
  remove_glossary_term: {
    ...
    calls: [{ method: "glossary.remove", args: [ACTOR, "P_projectId", "TID_termId"] }],
    result: { removed: "TID_termId" },
  },
  lookup_translation_memory: {
    input: { projectId: "P_projectId", locale: "zz", text: "X_text", limit: 7 },
    calls: [{ method: "tm.lookup", args: [ACTOR, "P_projectId", "zz", "X_text", 7] }],
  },
  ...
  add_webhook: {
    input: { projectId: "P_projectId", url: "https://h.example/wh", events: ["key.created"] },
    calls: [
      {
        method: "webhooks.add",
        args: [ACTOR, "P_projectId", { url: "https://h.example/wh", events: ["key.created"] }],
      },
    ],
  },
  remove_webhook: {
    input: { projectId: "P_projectId", webhookId: "WH_webhookId" },
    calls: [{ method: "webhooks.remove", args: [ACTOR, "P_projectId", "WH_webhookId"] }],
  ...
  // ---- qa --------------------------------------------------------------------
  run_qa_checks: {
    input: { projectId: "P_projectId", locale: "zz", checks: ["CK_check"], slot: "working" },
    calls: [
      {
        // Note the deliberate field rename: input `checks` → service `checkIds`.
        method: "qa.run",
        args: [ACTOR, "P_projectId", { locale: "zz", checkIds: ["CK_check"], slot: "working" }],
      },
    ],
  },
  get_qa_config: {
  ...
  set_qa_config: {
    input: {
      ...
      ignore: [{ checkId: "ICK_check", namespace: "NS_ns", keyName: "KN_key", locale: "zz" }],
    },
    calls: [
      {
        method: "qa.setConfig",
    ...
    calls: [
      {
        ...
        args: [
          ...
          "P_projectId",
          "zz",
          { name: "N_name", namespace: "NS_ns", score: 42, comment: "C_comment", model: "M_model" },
        ],
      },
    ],
  },
  review_translations: {
    input: {
      projectId: "P_projectId",
      locale: "zz",
      entries: [{ name: "N_name", namespace: "NS_ns", score: 42, comment: "C_comment", model: "M_model" }],
    },
    calls: [
      {
  ...
  set_score_config: {
    input: { projectId: "P_projectId", threshold: 77, autoApprove: true, guidance: "G_guidance" },
    calls: [
      {
        method: "scoring.setConfig",
        args: [ACTOR, "P_projectId", { threshold: 77, autoApprove: true, guidance: "G_guidance" }],
      },
    ],
  },
  ...
  create_user: {
    ...
    calls: [
      {
        method: "users.create",
        args: [ACTOR, { email: "owner_email@ex.co", name: "N_name", globalRole: "ADMIN" }],
      },
    ],
  },
  set_user_role: {
    input: { userId: "U_userId", globalRole: "ADMIN" },
    calls: [{ method: "users.setGlobalRole", args: [ACTOR, "U_userId", "ADMIN"] }],
  ...
  set_member_role: {
    ...
    calls: [{ method: "members.setRole", args: [ACTOR, "P_projectId", "U_userId", "EDITOR"] }],
  },
  remove_member: {
    input: { projectId: "P_projectId", userId: "U_userId" },
    calls: [{ method: "members.remove", args: [ACTOR, "P_projectId", "U_userId"] }],
    result: { removed: "U_userId" },
  },
  create_api_key: {
    input: { name: "N_name", userId: "U_userId", readOnly: true, expiresAt: "2099-01-01T00:00:00.000Z" },
    returns: {
      apiKey: {
        id: "key_id",
        name: "AK_name",
    ...
    calls: [
      {
        ...
        args: [ACTOR, { name: "N_name", userId: "U_userId", readOnly: true, expiresAt: "2099-01-01T00:00:00.000Z" }],
      },
    ],
    result: {
      id: "key_id",
  ...
  revoke_api_key: {
    ...
    calls: [{ method: "apiKeys.revoke", args: [ACTOR, "K_apiKeyId", "U_userId"] }],
  },
};
