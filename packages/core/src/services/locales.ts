import type { Locale } from "@turjuman/schema";
import { conflict } from "@turjuman/schema";
import type { Actor } from "@turjuman/schema";
import { requireLocale } from "@turjuman/schema";
...
export class LocalesService extends BaseService {
  ...
  async add(actor: Actor, projectId: string, code: string, name?: string): Promise<Locale> {
