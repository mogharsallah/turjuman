...
"@turjuman/aws-deploy": minor
"@turjuman/mcp-server": minor
"@turjuman/api": minor
---

Redesign the AWS deploy around a published, composable CDK construct + pre-bundled Lambda assets + the standard CDK bootstrap.
